    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-6">
           <div class="w-14 h-14 bg-indigo-50 text-indigo-600 flex items-center justify-center rounded-2xl">
           ...
           <div>
             ...
             <div class="text-sm font-bold text-slate-400 mt-1 uppercase tracking-wider text-[10px]">Doctores Activos</div>
           </div>
        </div>

        <!-- Total Appointments -->
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-6">
           <div class="w-14 h-14 bg-blue-50 text-blue-600 flex items-center justify-center rounded-2xl">
           ...
           <div>
             ...
             <div class="text-sm font-bold text-slate-400 mt-1 uppercase tracking-wider text-[10px]">Citas Registradas</div>
           </div>
        </div>

        <!-- Specialties -->
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-6">
           <div class="w-14 h-14 bg-amber-50 text-amber-600 flex items-center justify-center rounded-2xl">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
           </div>
           <div>
             <div class="text-3xl font-black text-slate-800">{{ totalSpecialties }}</div>
             <div class="text-sm font-bold text-slate-400 mt-1 uppercase tracking-wider text-[10px]">Especialidades</div>
           </div>
        </div>

        <!-- Appointment Types -->
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-6">
           <div class="w-14 h-14 bg-emerald-50 text-emerald-600 flex items-center justify-center rounded-2xl">
           ...
           <div>
             ...
             <div class="text-sm font-bold text-slate-400 mt-1 uppercase tracking-wider text-[10px]">Tipos de Cita</div>
           </div>
        </div>
        
        <!-- Offices -->
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-6">
           <div class="w-14 h-14 bg-rose-50 text-rose-600 flex items-center justify-center rounded-2xl">
           ...
           <div>
             ...
             <div class="text-sm font-bold text-slate-400 mt-1 uppercase tracking-wider text-[10px]">Oficinas</div>
           </div>
        </div>
      </div>
