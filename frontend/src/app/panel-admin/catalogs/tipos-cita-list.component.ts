  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        >
         ...
         <div class="overflow-x-auto">
          ...
          <tbody class="divide-y divide-slate-50">
            <tr
              *ngFor="let item of filteredTypes | slice: 0 : visibleCount; let i = index"
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap text-center">
                <span
                  class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-indigo-50 text-indigo-700"
                >
        ...
        <!-- Paginación local -->
        <div
          *ngIf="filteredTypes.length > visibleCount"
...
export class TiposCitaListComponent implements OnInit {
  ...
  confirmDelete() {
    ...
    this.catalogsService.deleteAppointmentType(this.idToDelete).subscribe({
      next: () => {
        this.showDeleteConfirm = false;
        this.idToDelete = null;
        this.loadData();
