    ...
    <div class="min-h-screen bg-slate-100 flex font-sans overflow-hidden">
      ...
      <aside 
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          <a (click)="onLinkClick()" routerLink="metricas" routerLinkActive="bg-green-600 text-white" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 transition-colors font-medium">
          ...
          <a (click)="onLinkClick()" routerLink="doctores" routerLinkActive="bg-green-600 text-white" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 transition-colors font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            Doctores
          </a>
          <a (click)="onLinkClick()" routerLink="especialidades" routerLinkActive="bg-green-600 text-white" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 transition-colors font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            Especialidades
          </a>
          <a (click)="onLinkClick()" routerLink="tipos-cita" routerLinkActive="bg-green-600 text-white" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 transition-colors font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
            Tipos de Cita
          </a>
          <a (click)="onLinkClick()" routerLink="oficinas" routerLinkActive="bg-green-600 text-white" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 transition-colors font-medium">
          ...
          <a (click)="onLinkClick()" routerLink="agenda" routerLinkActive="bg-green-600 text-white" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 transition-colors font-medium text-slate-400">
      ...
      <main 
        ...
        <header class="bg-white border-b border-slate-200 px-4 md:px-8 py-4 md:py-5 flex items-center justify-between sticky top-0 z-10 shadow-sm shrink-0">
           <div class="flex items-center gap-4">
             <button (click)="toggleSidebar()" class="p-2 -ml-2 rounded-lg hover:bg-slate-100 text-slate-600 focus:outline-none transition-colors">
