      ...
      <header class="bg-white border-b border-slate-200 sticky top-0 z-10 px-2 sm:px-4 py-2 sm:py-3 shadow-sm">
        ...
        >
          ...
          <nav class="flex gap-2 items-center">
            ...
            <button
              (click)="logout()"
              class="text-xs font-bold text-red-500 uppercase tracking-widest hover:bg-red-50 px-3 py-2 rounded-xl transition-all flex items-center gap-1.5 focus:outline-none"
            >
              <svg
